...
| Multilingual checkout | English and Japanese journeys must remain usable | M6 `LOC-01` to `SAFE-05` | Planned Playwright, unit, and manual evidence | Draft for review |
