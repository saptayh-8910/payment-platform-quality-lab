...
| Detailed declines | Different declined outcomes must preserve one final state, one reason, no financial effect, safe retry behavior, and useful localized guidance | [Enhancement 1 catalog](enhancements/e1-detailed-decline-outcomes/scenario-catalog.md) | Planned unit, API, integration, webhook, Node, browser, exploratory, and privacy evidence | Approved plan; not executed |
