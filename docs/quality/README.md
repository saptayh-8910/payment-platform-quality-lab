...
| 2 | Asynchronous payment confirmation | [Catalog](enhancements/e2-asynchronous-payment-confirmation/scenario-catalog.md) | Not yet executed | In progress: migration foundation |
