...
| 2 | Asynchronous payment confirmation | [Catalog](enhancements/e2-asynchronous-payment-confirmation/scenario-catalog.md), [race review](enhancements/e2-asynchronous-payment-confirmation/race-resolution-review.md), and [cancellation review](enhancements/e2-asynchronous-payment-confirmation/cancellation-review.md) | [Migration](enhancements/e2-asynchronous-payment-confirmation/migration-foundation-report.md), [confirmation](enhancements/e2-asynchronous-payment-confirmation/confirmation-processing-report.md), [expiry](enhancements/e2-asynchronous-payment-confirmation/scheduled-expiry-report.md), [race/recovery](enhancements/e2-asynchronous-payment-confirmation/race-resolution-report.md), and [cancellation report](enhancements/e2-asynchronous-payment-confirmation/cancellation-report.md) | In progress: cancellation implemented; reconciliation expansion, localization, and closeout remain |
