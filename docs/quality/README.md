...
| 2 | Asynchronous payment confirmation | [Catalog](enhancements/e2-asynchronous-payment-confirmation/scenario-catalog.md) | [Migration foundation report](enhancements/e2-asynchronous-payment-confirmation/migration-foundation-report.md), [confirmation processing report](enhancements/e2-asynchronous-payment-confirmation/confirmation-processing-report.md), and [scheduled expiry report](enhancements/e2-asynchronous-payment-confirmation/scheduled-expiry-report.md); enhancement closing report not yet executed | In progress: migration, creation, signed processing, replay protection, anomaly classification, and scheduled expiry implemented; forced race, cancellation, reconciliation, localization, and closeout remain |
