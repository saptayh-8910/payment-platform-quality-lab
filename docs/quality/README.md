...
| 2 | Asynchronous payment confirmation | [Catalog](enhancements/e2-asynchronous-payment-confirmation/scenario-catalog.md) | [Migration foundation report](enhancements/e2-asynchronous-payment-confirmation/migration-foundation-report.md) and [confirmation processing report](enhancements/e2-asynchronous-payment-confirmation/confirmation-processing-report.md); enhancement closing report not yet executed | In progress: migration, creation, signed processing, replay protection, and anomaly classification implemented; scheduled expiry, forced race, cancellation, reconciliation, localization, and closeout remain |
