...
| 2 | Asynchronous payment confirmation | [Catalog](enhancements/e2-asynchronous-payment-confirmation/scenario-catalog.md) and [approved race review](enhancements/e2-asynchronous-payment-confirmation/race-resolution-review.md) | [Migration](enhancements/e2-asynchronous-payment-confirmation/migration-foundation-report.md), [confirmation](enhancements/e2-asynchronous-payment-confirmation/confirmation-processing-report.md), [expiry](enhancements/e2-asynchronous-payment-confirmation/scheduled-expiry-report.md), and [race/recovery report](enhancements/e2-asynchronous-payment-confirmation/race-resolution-report.md) | In progress: SQLite race and recovery implemented; cancellation, reconciliation expansion, localization, and closeout remain |
